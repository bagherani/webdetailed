...
<LessonNavigation nextUrl={''} nextText={''} prevUrl={'/nextjs-15/project-organization'} prevText={'Mastering Next.js Folder Structure: Best Practices for Organizing Your Project'}/>
